...
//---- Top entity
module main #(
 parameter v24725a = "v24725a.list",
 parameter v136934 = 12000000*(0.25),
 parameter v59db95 = 12000000*(1)
) (
 input v745411,
 input vcc3aaf,
 input v61265d,
 ...
 localparam p11 = v24725a;
 localparam p13 = v136934;
 localparam p16 = v59db95;
 wire w0;
 wire w1;
 wire w2;
 wire [0:7] w3;
...
/*-- mi-tabla8-2  */
/*-- - - - - - - - - - - - - - - - - - - - - - - --*/
/*-- Circuito combinacional de 8 entradas y 2 salidas
/*-------------------------------------------------*/

module v98e5ae_v361fe9 #(
 parameter DATA = 0
) (
 input [7:0] i,
 output [1:0] q
